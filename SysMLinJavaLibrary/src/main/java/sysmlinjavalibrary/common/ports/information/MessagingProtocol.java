...
public class MessagingProtocol extends SysMLFullPort
{	
	public MessagingProtocol(SysMLBlock contextBlock, Long id, String name)
	{
		super(contextBlock, Optional.of(contextBlock), id, name);
	}

	public MessagingProtocol(SysMLBlock contextBlock, Long id)
	{
